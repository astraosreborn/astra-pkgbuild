...
project="astra-pkgbuild"
githubdir="astraosreborn"
echo "-----------------------------------------------------------------------------"
echo "Welcome to the astraOS Project!"
echo "-----------------------------------------------------------------------------"
...
case $CHOICE in
    ...
    1 )
			...
			git config --global user.name "ryzenstechdev"
			git config --global user.email "ryzenstech@gmail.com"
